...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				"Asdasdasdfaf|Grim Batol|Alliance|1|PRIEST", -- [1]
				"Bawsie|Grim Batol|Alliance|110|HUNTER", -- [2]
				"Bawsi|Aggra (Português)|Alliance|21|HUNTER", -- [3]
				"Bawsi|Shattered Hand|Horde|29|HUNTER", -- [4]
				"Daimtårta|Aggra (Português)|Alliance|90|PRIEST", -- [5]
				"Donchyo|Shattered Hand|Horde|82|DEATHKNIGHT", -- [6]
				"Donch|Crushridge|Alliance|70|SHAMAN", -- [7]
				"Donch|Grim Batol|Alliance|110|MAGE", -- [8]
				"Donch|Shattered Hand|Alliance|80|DEATHKNIGHT", -- [9]
				"Gnomalock|Grim Batol|Alliance|102|WARLOCK", -- [10]
				"Greenzuriz|Aggra (Português)|Horde|15|SHAMAN", -- [11]
				"Krixidh|Grim Batol|Alliance|110|DEMONHUNTER", -- [12]
				"Krixidh|Ravencrest|Alliance|120|DEMONHUNTER", -- [13]
				"Krixidk|Grim Batol|Alliance|110|DEATHKNIGHT", -- [14]
				"Krixidk|Ravencrest|Alliance|120|DEATHKNIGHT", -- [15]
				"Krixidk|Valley of Heroes - EU|Horde|110|DEATHKNIGHT", -- [16]
				"Kriximonk|Ravencrest|Alliance|120|MONK", -- [17]
				"Krixiqt|Ravencrest|Alliance|120|PALADIN", -- [18]
				"Krixirogue|Ravencrest|Alliance|120|ROGUE", -- [19]
				"Krixiswag|Aggra (Português)|Horde|1|PALADIN", -- [20]
				"Krixiyo|Blackmoore|Alliance|1|PALADIN", -- [21]
				"Krixiyo|Lightning's Blade|Horde|1|ROGUE", -- [22]
				"Krixiyo|Twisting Nether|Horde|2|WARRIOR", -- [23]
				"Krixi|Grim Batol|Alliance|110|PALADIN", -- [24]
				"Kroxidps|Aggra (Português)|Alliance|4|WARRIOR", -- [25]
				"Kroxi|Crushridge|Alliance|90|WARRIOR", -- [26]
				"Kroxi|Grim Batol|Alliance|110|WARRIOR", -- [27]
				"Kroxi|Ravencrest|Alliance|120|WARRIOR", -- [28]
				"Lilgaykrixi|Kazzak|Horde|39|WARRIOR", -- [29]
				"Lowerboost|Lightbringer|Alliance|1|PRIEST", -- [30]
				"Líttle|Grim Batol|Alliance|100|DEATHKNIGHT", -- [31]
				"Memeinhaler|Ravencrest|Alliance|28|HUNTER", -- [32]
				"Menardiairl|Culte de la Rive noire|Alliance|1|SHAMAN", -- [33]
				"Namji|Grim Batol|Alliance|110|MONK", -- [34]
				"Nyrith|Grim Batol|Alliance|110|DRUID", -- [35]
				"Spacegoatx|Aggra (Português)|Alliance|69|PALADIN", -- [36]
				"Treefiddy|Aggra (Português)|Alliance|90|DEATHKNIGHT", -- [37]
				"Zetiz|Grim Batol|Alliance|110|ROGUE", -- [38]
				"Zolution|Grim Batol|Alliance|110|PRIEST", -- [39]
				"Zuriz|Grim Batol|Alliance|110|SHAMAN", -- [40]
			},
		},
	},
	["profiles"] = {
		["Krixiqt - Ravencrest"] = {
			...
			["BlackBook"] = {
				["recent"] = {
					"Kriximonk|Ravencrest|Alliance", -- [1]
					"Krixidk|Ravencrest|Alliance", -- [2]
					"Swecat|Ravencrest|Alliance", -- [3]
					"Shallina|Ravencrest|Alliance", -- [4]
					"Krixidh|Ravencrest|Alliance", -- [5]
					"Bamo|Ravencrest|Alliance", -- [6]
					"Krixirogue|Ravencrest|Alliance", -- [7]
				},
			},
		},
		...
		["Kriximonk - Ravencrest"] = {
			["BlackBook"] = {
				["recent"] = {
					"Krixiqt|Ravencrest|Alliance", -- [1]
					"Aljan|Ravencrest|Alliance", -- [2]
					"Krixidk|Ravencrest|Alliance", -- [3]
				},
			},
		},
		["Krixidh - Ravencrest"] = {
			["BlackBook"] = {
				["recent"] = {
					"Krixidk|Ravencrest|Alliance", -- [1]
					"KrixIDK|Ravencrest|Alliance", -- [2]
					"Krixiqt|Ravencrest|Alliance", -- [3]
				},
			},
		},
		["Krixidk - Ravencrest"] = {
			["BlackBook"] = {
				["recent"] = {
					"Kriximonk|Ravencrest|Alliance", -- [1]
					"Krixiqt|Ravencrest|Alliance", -- [2]
					"Nex|Ravencrest|Alliance", -- [3]
					"Kroxi|Ravencrest|Alliance", -- [4]
				},
			},
		},
		...
		["Donch - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					"Krixidk|Grim Batol|Alliance", -- [1]
					"Zuriz|Grim Batol|Alliance", -- [2]
					"Krixidh|Grim Batol|Alliance", -- [3]
					"Zetiz|Grim Batol|Alliance", -- [4]
					"Zolution|Grim Batol|Alliance", -- [5]
					"Krixi|Grim Batol|Alliance", -- [6]
					"Kavick|Grim Batol|Alliance", -- [7]
					"Dunkelman|Grim Batol|Alliance", -- [8]
					"Bawsie|Grim Batol|Alliance", -- [9]
					"Menardia|Grim Batol|Alliance", -- [10]
					"Kroxi|Grim Batol|Alliance", -- [11]
					"Nyrith|Grim Batol|Alliance", -- [12]
					"Líttle|Grim Batol|Alliance", -- [13]
					"Angievarona|Grim Batol|Alliance", -- [14]
		...
		["Kroxi - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Diamondfoxx|Grim Batol|Alliance", -- [5]
					"Zetiz|Grim Batol|Alliance", -- [6]
					"Zolution|Grim Batol|Alliance", -- [7]
					"Bawsie|Grim Batol|Alliance", -- [8]
					"Namji|Grim Batol|Alliance", -- [9]
					"Menardia|Grim Batol|Alliance", -- [10]
					"Donch|Grim Batol|Alliance", -- [11]
					"Eililililili|Grim Batol|Alliance", -- [12]
					"Bekkett|Grim Batol|Alliance", -- [13]
					"Estefano|Grim Batol|Alliance", -- [14]
					"Gnomalock|Grim Batol|Alliance", -- [15]
					"Treefiddy-Aggra (Português)|Grim Batol|Alliance", -- [16]
				},
			},
		},
		...
		["Bawsie - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					"Krixidk|Grim Batol|Alliance", -- [1]
					"Kroxi|Grim Batol|Alliance", -- [2]
					"Nyrith|Grim Batol|Alliance", -- [3]
					"Zuriz|Grim Batol|Alliance", -- [4]
					"Krixidh|Grim Batol|Alliance", -- [5]
					"Menardians|Grim Batol|Alliance", -- [6]
					"Zetiz|Grim Batol|Alliance", -- [7]
					"Zolution|Grim Batol|Alliance", -- [8]
					"Krixi|Grim Batol|Alliance", -- [9]
					"Dunkelman|Grim Batol|Alliance", -- [10]
					"Menardia|Grim Batol|Alliance", -- [11]
					"Namji|Grim Batol|Alliance", -- [12]
					"Donch|Grim Batol|Alliance", -- [13]
					"Gnomalock|Grim Batol|Alliance", -- [14]
					"Kavick|Grim Batol|Alliance", -- [15]
					"Eililililili|Grim Batol|Alliance", -- [16]
					"Líttle|Grim Batol|Alliance", -- [17]
					"Bossacur-GrimBatol|Grim Batol|Alliance", -- [18]
					"Vicsur|Grim Batol|Alliance", -- [19]
					"Krixi-GrimBatol|Grim Batol|Alliance", -- [20]
				},
			},
		},
		...
		["Nyrith - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					"Zetiz|Grim Batol|Alliance", -- [1]
					"Krixidk|Grim Batol|Alliance", -- [2]
					"Kroxi|Grim Batol|Alliance", -- [3]
					"Zuriz|Grim Batol|Alliance", -- [4]
					"Menardia|Grim Batol|Alliance", -- [5]
					"Menardians|Grim Batol|Alliance", -- [6]
					"Zolution|Grim Batol|Alliance", -- [7]
					"Donch|Grim Batol|Alliance", -- [8]
					"Krixi|Grim Batol|Alliance", -- [9]
					"Bawsie|Grim Batol|Alliance", -- [10]
					"Dunkelman|Grim Batol|Alliance", -- [11]
					"Namji|Grim Batol|Alliance", -- [12]
					"Daimtårta|Grim Batol|Alliance", -- [13]
					"Líttle|Grim Batol|Alliance", -- [14]
					"Kavick|Grim Batol|Alliance", -- [15]
					"Diamondfoxx|Grim Batol|Alliance", -- [16]
					"Vicsur|Grim Batol|Alliance", -- [17]
					"Gnomalock|Grim Batol|Alliance", -- [18]
					"Estefano|Grim Batol|Alliance", -- [19]
					"Spacegoatx-Aggra(Português)|Grim Batol|Alliance", -- [20]
				},
			},
		},
		...
		["Zetiz - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Krixi|Grim Batol|Alliance", -- [4]
					"Menardia|Grim Batol|Alliance", -- [5]
					"Ccookie-aggra(Português)|Grim Batol|Alliance", -- [6]
					"Bawsie|Grim Batol|Alliance", -- [7]
					"Dunkelman|Grim Batol|Alliance", -- [8]
					"Namji|Grim Batol|Alliance", -- [9]
					"Kroxi|Grim Batol|Alliance", -- [10]
					"Líttle|Grim Batol|Alliance", -- [11]
					"Donch|Grim Batol|Alliance", -- [12]
					"Eililililili|Grim Batol|Alliance", -- [13]
					"Kegvick|Grim Batol|Alliance", -- [14]
					"Kavick|Grim Batol|Alliance", -- [15]
					"Vicser|Grim Batol|Alliance", -- [16]
					"Gnomalock|Grim Batol|Alliance", -- [17]
					"Zolution|Grim Batol|Alliance", -- [18]
				},
			},
		},
		...
		["Líttle - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					"Zetiz|Grim Batol|Alliance", -- [1]
					"Zolution|Grim Batol|Alliance", -- [2]
					"Krixi|Grim Batol|Alliance", -- [3]
					"Donch|Grim Batol|Alliance", -- [4]
					"Zuriz|Grim Batol|Alliance", -- [5]
					"Dunkelman|Grim Batol|Alliance", -- [6]
					"Kroxi|Grim Batol|Alliance", -- [7]
					"Bawsie|Grim Batol|Alliance", -- [8]
					"Menardia|Grim Batol|Alliance", -- [9]
					"Nyrith|Grim Batol|Alliance", -- [10]
					"Eililililili|Grim Batol|Alliance", -- [11]
					"Ehsi|Grim Batol|Alliance", -- [12]
					"Gnomalock|Grim Batol|Alliance", -- [13]
				},
			},
		},
		["Krixidh - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					...
					"Nyrith|Grim Batol|Alliance", -- [2]
					"Zuriz|Grim Batol|Alliance", -- [3]
					"Spacegoaty|Grim Batol|Alliance", -- [4]
					"Vicserdh|Grim Batol|Alliance", -- [5]
					"Bawsie|Grim Batol|Alliance", -- [6]
					"Donch|Grim Batol|Alliance", -- [7]
					"Krixi|Grim Batol|Alliance", -- [8]
				},
			},
		},
		...
		["Zuriz - Grim Batol"] = {
			["BlackBook"] = {
				["recent"] = {
					"Krixidk|Grim Batol|Alliance", -- [1]
					"Nyrith|Grim Batol|Alliance", -- [2]
					"Spacegoaty|Grim Batol|Alliance", -- [3]
					"Krixi|Grim Batol|Alliance", -- [4]
					"Donch|Grim Batol|Alliance", -- [5]
					"Zetiz|Grim Batol|Alliance", -- [6]
					"Zolution|Grim Batol|Alliance", -- [7]
					"Kroxi|Grim Batol|Alliance", -- [8]
					"Dunkelman|Grim Batol|Alliance", -- [9]
					"Menardia|Grim Batol|Alliance", -- [10]
					"Gnomalock|Grim Batol|Alliance", -- [11]
					"Líttle|Grim Batol|Alliance", -- [12]
					"Bawsie|Grim Batol|Alliance", -- [13]
					"Greenzuriz-Aggra (Português)|Grim Batol|Alliance", -- [14]
				},
			},
		},
