...
ns.L = {
	...
	CONFIG_AUTO_PLACE_SIMPLE = "Posiziona automaticamente i seguaci", -- Needs review
	CONFIG_AUTO_PLACE_SIMPLE_EXPLAIN = "I seguaci verranno piazzati automaticamente nel party solo se sono gli unici a poter contrastare una minaccia, Se sono piu' di uno, la scelta resta a voi", -- Needs review
	CONFIG_AVAILABLE = "Available", -- Requires localization
	CONFIG_BASIC = "Opzioni Base", -- Needs review
	...
	CONFIG_COUNTER_TRAIT = "Mostra le minaccie di una missione e se possono essere contrastate", -- Needs review
	...
	CONFIG_FAST_ASSIGN = "Abilita il clic col destro per assegnare/rimuovere un seguace da una missione", -- Needs review
	CONFIG_FAST_ASSIGN_EXPLAIN = "Questo disattiva il menu contestuale su right click, ma solo sulla pagina di dettaglio della missione o sui seguaci disponibili o già in party, altrimenti non fa nulla", -- Needs review
	CONFIG_FOLLOWER = "Follower", -- Requires localization
	CONFIG_FOLLOWER_REQUIRED = "Mostra quanti seguaci richiede la missione", -- Needs review
	CONFIG_GLOBAL_SAVE = "Configurazione globale", -- Needs review
	CONFIG_GLOBAL_SAVE_EXPLAIN = "Se attiva, tuttu i tuoi personaggi useranno una configurazione comune. Disattivalo per usare opzioni differenti per ogni persionaggio", -- Needs review
	...
	CONFIG_ON_MISSION = "Mostra da quanto tempo sei in missione", -- Needs review
	...
	CONFIG_SHOW_TIME_LEFT = "Mostra il tempo rimanente a un seguace per terminare una missione", -- Needs review
	...
	FOLLOWER_REQUIRED = "E' richiesto un seguace", -- Needs review
	ITEM_LEVEL = "iLevel", -- Requires localization
	LEVEL = "Level", -- Requires localization
	MISSION_AVAILABLE = "Missione disponibile", -- Needs review
	...
	SALVAGE_YARD = "Centro di Riciclaggio", -- Needs review
