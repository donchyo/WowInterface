...
do
	...
	function GUIDIsPlayer(guid)
		--[[
			...
			For creatures, pets and vehicles: [Unit type]:0:[server ID]:[instance ID]:[zone UID]:[Npc ID]:[Spawn UID] (Example: "Creature:0:976:0:11:31146:000136DF91")
			
			className, classId, raceName, raceId, gender, name, realm = GetPlayerInfoByGUID("guid")
		]]
		
	--	local test = GetPlayerInfoByGUID(guid)
		
	--	print(guid, type(test))
		
	--	B = tonumber(guid:sub(-13, -9), 16);
