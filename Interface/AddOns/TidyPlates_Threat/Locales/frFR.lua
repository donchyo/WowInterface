...
local L = LibStub("AceLocale-3.0"):NewLocale("TidyPlates_Threat", "frFR")
if not L then return end

L[" options by typing: /tptp"] = " options en inscrivant: /tptp"
L[" role."] = "rôle."
...
L["Y"] = "Y"
L["Yes"] = "Yes"
L["you are now in your "] = "vous êtes maintenant dans votre"
