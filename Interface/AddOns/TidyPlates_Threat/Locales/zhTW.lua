...
local L = LibStub("AceLocale-3.0"):NewLocale("TidyPlates_Threat", "zhTW")
...
L["-->>Verbose is now |cff00ff00ON!|r<<--"] = "-->>Threat Plates聊天框反饋信息現在 |cff00ff00開啟！|r<<--"
L["-->>Verbose is now |cffff0000OFF!|r<<-- shhh!!"] = "-->>Threat Plates聊天框反饋信息現在 |cffff0000關閉！|r<<--噓！！"
L["About"] = "關於"
...
L["Disables threat feedback from tapped mobs regardless of boss or elite levels."] = "停用無法拾取怪物的威脅反饋無論是首領或是精英等級。"
...
L["key_FirstWelcome"] = [=[|cff89f559歡迎使用 |rTidy Plates: |cff89f559Threat!
這是你第一次使用Threat，你是一個：
|r|cff]=]
L["key_FontWarning"] = [=[這些設置將定義文字放置在姓名板上的空間。
過大的字體與高度不足將導致導致文字不可見。]=]
L["key_SetThemePopup"] = [=[:
----------
你希望 
設置你的主題為 |cff89F559Threat|r嗎?

點擊 '|cff00ff00是|r' 將設置你的主題為Threat並且重新載入插件。
...
-- L["Pet"] = ""
L["Placement"] = "位置"
L["Player spec change detected"] = "玩家專精改變檢測"
L["Presences"] = "領域"
L["Preview"] = "預覽"
L["Primary Spec"] = "主要天賦"
--Translation missing 
...
L["Show Non-Combat Threat"] = "忽略非戰鬥目標仇恨"
...
--Translation missing 
-- L["Show Tapped"] = ""
L["Show Tapped Threat"] = "顯示無法拾取的威脅"
...
L["This widget will display a small shield or dagger that will indicate if the nameplate is currently being tanked."] = "這個組件將顯示一個用來指示單位當前是否被坦住的盾或匕首。"
...
L["Y"] = "Y軸"
L["Yes"] = "是"
L["you are now in your "] = "你現在啟用了你的 "
