...
local L = LibStub("AceLocale-3.0"):NewLocale("TidyPlates_Threat", "deDE")
...
L["-->>Verbose is now |cff00ff00ON!|r<<--"] = "-->>Threat Plates-Meldungen sind nun |cff00ff00ON!|r<<--"
L["-->>Verbose is now |cffff0000OFF!|r<<-- shhh!!"] = "-->>Threat Plates-Meldungen sind nun |cffff0000OFF!|r<<-- psst!!"
L["About"] = "Über"
...
L["Custom Color"] = "Benutzerdefinierte Farben des HP-Balkens"
...
L["Display health text on targets with full HP."] = "Zeigt den Gesundheitstext bei Zielen mit voller Gesundheit an."
...
L["Enable Health Text"] = "Gesundheitstext einschalten"
...
L["key_FirstWelcome"] = [=[|cff89f559Willkommen bei |rTidy Plates: |cff89f559Threat!
Das ist das erste Mal, dass Du Threat benutzt und Du bist ein(n):
|r|cff]=]
L["key_FontWarning"] = [=[Diese Einstellungen definieren den Platz, der einem Text auf der Plakette zur Verfügung steht.
Eine zu große Schriftart mit zu niedriger Höhe wird dazu führen, dass der Text nicht sichtbar ist.]=]
L["key_SetThemePopup"] = [=[:
----------
Möchtest Du Deine Anzeige auf |cff89F559Threat|r umschalten?

Ein Klick auf '|cff00ff00Ja|r' wird Threat voreinstellen. 
...
L["Player spec change detected"] = "Talentwechsel festgestellt"
...
L["Show Non-Combat Threat"] = "Kampffreie Bedrohung ignorieren"
...
--Translation missing 
-- L["Tagged Color"] = ""
L["Tanked Widget"] = "Getankte Ziele"
--Translation missing 
-- L["Tapped"] = ""
...
L["This widget will display a small shield or dagger that will indicate if the nameplate is currently being tanked."] = "Ermöglicht die Anzeige eines kleinen Schilds oder Dolches an der Namensplakette zur Anzeige, ob das Ziel derzeit getankt wird."
...
L["Y"] = "Y"
L["Yes"] = "Ja"
L["you are now in your "] = "Du bist jetzt in Deiner "
