...
local L = LibStub("AceLocale-3.0"):NewLocale("TidyPlates_Threat", "zhCN")
...
L["-->>Verbose is now |cff00ff00ON!|r<<--"] = "-->>Threat Plates聊天框反馈信息现在 |cff00ff00开启！|r<<--"
L["-->>Verbose is now |cffff0000OFF!|r<<-- shhh!!"] = "-->>Threat Plates聊天框反馈信息现在 |cffff0000关闭！|r<<--嘘！！"
L["About"] = "关于"
...
L["Always Show Auras"] = "永久显示减益状态（Auras）"
L["Amount Text"] = "数值文字"
...
L["Disables threat feedback from tapped mobs regardless of boss or elite levels."] = "禁用当前不在与你战斗的怪物的仇恨反馈。"
...
L["Enable Reaction Colors"] = "启用反应颜色"
...
L["Enable Text Only Style"] = "只显示文字样式"
...
L["Enable to hide the healthbar, castbar and other art for selected unit types."] = "为特定的单位类型启用隐藏其血条，施法条以及其他的艺术。"
...
L["Icon Size"] = "图标大小"
L["Icon width"] = "图标宽度"
L["Icons on a line"] = "线上的图标"
L["Ignore Marked Targets"] = "忽略被标记的目标"
L["Immortal Guardian"] = "不朽守护者"
L["Interruptable Casts"] = "可打断的施法"
L["key_FirstWelcome"] = [=[|cff89f559欢迎使用 |rTidy Plates: |cff89f559Threat!
这是你第一次使用Threat，你是一个：
|r|cff]=]
L["key_FontWarning"] = [=[这些设置将定义文字放置在姓名板上的空间。
过大的字体与高度不足将导致导致文字不可见。]=]
L["key_SetThemePopup"] = [=[:
----------
你希望 设置你的主题为 |cff89F559Threat|r吗?

点击 '|cff00ff00是|r' 将设置你的主题为Threat并且重新载入插件。
...
L["Max Distance Nameplate Visibility"] = "最大距离下的姓名版的能见度"
L["Max HP Text"] = "最大血量文字"
L["Medium Threat"] = "中等仇恨"
L["Mini Mob NPC"] = "小宠物NPC"
L["Mode"] = "模式"
L["Mouseover"] = "鼠标指向"
...
L["Override alpha settings"] = "重置透明度设置"
L["Paste"] = "粘贴"
L["Pasted!"] = "已粘贴！"
L["Percent Text"] = "百分比文字"
L["Pet"] = "宠物"
L["Placement"] = "位置"
L["Player spec change detected"] = "玩家天赋改变检测"
L["Presences"] = "灵气"
L["Preview"] = "预览"
L["Primary Spec"] = "主天赋"
L["Quest Icons"] = "任务图标"
...
L["Text Height"] = "文字高度"
L["Text Only Style"] = "文字样式"
L["Text Width"] = "文字宽度"
L["Texture"] = "材质"
L["Textures"] = "材质"
L["Textures are reversed for tanking role."] = "反转坦克角色的材质"
...
L["This widget will display a small shield or dagger that will indicate if the nameplate is currently being tanked."] = "这个组件将显示一个用来指示单位当前是否被坦住的盾或匕首。"
...
L["This widget will display quest icons on nameplates that are quest objectives."] = "这个组件将会把任务目标的任务图标显示在姓名版上"
...
L["Toggle the display of a border around the icon."] = "切换显示图标周围的边框"
L["Toggle the display of a radial cooldown over the icon."] = "切换显示在图标上的冷却时间"
L["Toggles"] = "切换"
L["Toggling"] = "切换"
L["Totem Alpha"] = "图腾透明度"
...
L["Type each spell name on a new line."] = "在每个新的行列中输入法术名称。"
L["Undetermined"] = "未确定"
...
L["Use the alpha set below for text only style."] = "仅在文本样式中使用透明度设置。"
