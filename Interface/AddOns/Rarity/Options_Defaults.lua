   ...
   groups = {
    ...
    pets = {
     ...
     ["Ice Chip"] =                                      { cat = HOLIDAY, type = PET, method = USE, name = L["Ice Chip"], spellId = 74932, itemId = 53641, items = { 54536 }, chance = 25, groupSize = 5, equalOdds = true, creatureId = 40198, lockDungeonId = 286, coords = {{m=728,x=31.2,y=50.8,i=true,n=L["Ahune"]}}, },
					...
					["Moon Moon"] =                                     { cat = HOLIDAY, type = PET, method = NPC, name = L["Moon Moon"], spellId = 144761, itemId = 101570, npcs = { 71992 }, chance = 17,  creatureId = 72160, holidayTexture = CALENDAR_DARKMOONFAIRE, coords = {{m=823,x=39.8,y=44.4,n=L["Moonfang"]}}, },
     ...
     ["Toxic Wasteling"] =                               { cat = HOLIDAY, type = PET, method = USE, name = L["Toxic Wasteling"], spellId = 71840, itemId = 50446, items = { 54537 }, chance = 14, groupSize = 5, equalOdds = true, creatureId = 38374, lockDungeonId = 288, coords = {{m=764,x=40.8,y=52.6,f=1,i=true}}, },
					-- 1.x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ["Cat Carrier (Black Tabby)"] =                     { cat = BASE, type = PET, method = NPC, name = L["Cat Carrier (Black Tabby)"], spellId = 10675, itemId = 8491, npcs = { 2372, 49116, 2385, 48741, 2248, 48184, 49269, 48628, 48017, 47204, 48260, 49245, 47861, 2373, }, chance = 10000,  creatureId = 7383, coords = {{m=24}}, },
     ["Dark Whelpling"] =                                { cat = BASE, type = PET, method = NPC, name = L["Dark Whelpling"], spellId = 10695, itemId = 10822, npcs = { 4324, 42042, 2725, 46916, 7049, 4323, 46914 }, chance = 1000,  creatureId = 7543, coords = {{m=17,x=29.6,y=44.2}, {m=17,x=71.8,y=47.6}, {m=17,x=11.2,y=41.0}, {m=29,x=16.8,y=64.8}, {m=29,x=23.8,y=64.4}, {m=40,x=63.8,y=50.6}, {m=141,x=47.6,y=69.8}}, },
     ["Disgusting Oozeling"] =                           { cat = BASE, type = PET, method = USE, name = L["Disgusting Oozeling"], spellId = 25162, itemId = 20769, items = { 20768 }, chance = 85,  creatureId = 15429, tooltipNpcs = { 1806, 1808, 12387, 3928, 43158, 43123, 44988, 44967, 4394, 4393, 7092, 48315, 7093, 7086, 48136, 48319, 48322, 3295, 8607, 8606, 15335, 41573, 47397, 11741, 11740, 14477, 46997, 42952, 2656, 2655, 6559, 9477, 6557, 42669, 41145, 1032, 41147, 41453, 51028, 49347, 50319, 48768, }, coords = { {m=43},{m=1060},{m=851},{m=182},{m=24},{m=11},{m=502},{m=717},{m=615},{m=261},{m=37},{m=26},{m=201},{m=39},{m=40},{m=281},{m=38}, }, },
     ["Parrot Cage (Green Wing Macaw)"] =                { cat = BASE, type = PET, method = NPC, name = L["Parrot Cage (Green Wing Macaw)"], spellId = 10683, itemId = 8492, npcs = { 48522 }, chance = 33,  creatureId = 7387, coords = {{m=756,f=1,x=55,y=39.6,i=true}}, },
     ["Parrot Cage (Hyacinth Macaw)"] =                  { cat = BASE, type = PET, method = ZONE, name = L["Parrot Cage (Hyacinth Macaw)"], spellId = 10682, itemId = 8494, zones = { "689", "37", "673" }, chance = 10000,  creatureId = 7391, coords = {{m=37}, {m=673}}, },
     ...
     ["Tiny Crimson Whelpling"] =                        { cat = BASE, type = PET, method = ZONE, name = L["Tiny Crimson Whelpling"], spellId = 10697, itemId = 8499, zones = { "40" }, chance = 10000,  creatureId = 7544, coords = {{m=40}}, },
     ["Tiny Emerald Whelpling"] =                        { cat = BASE, type = PET, method = NPC, name = L["Tiny Emerald Whelpling"], spellId = 10698, itemId = 8498, npcs = { 740, 741, 39384 }, chance = 1000,  creatureId = 7545, coords = {{m=121,x=49.6,y=8.6}}, },
					-- 2.x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ["Azure Whelpling"] =                               { cat = TBC, type = PET, method = ZONE, name = L["Azure Whelpling"], spellId = 10696, itemId = 34535, zones = { "281" }, chance = 10000,  creatureId = 7547, coords = {{m=281}}, },
     ["Captured Firefly"] =                              { cat = TBC, type = PET, method = NPC, name = L["Captured Firefly"], spellId = 36034, itemId = 29960, npcs = { 20197 }, chance = 1000,  creatureId = 21076, coords = {{m=467,x=47.6,y=32.6}}, },
     ...
     ["Toothy's Bucket"] =                               { cat = TBC, type = PET, method = USE, name = L["Toothy's Bucket"], spellId = 43697, itemId = 33816, items = { 35348 }, chance = 10, creatureId = 24388, coords = {{m=481,x=54.6,y=39.6,n=L["Cupri"]}, {m=478,x=38.6,y=12.8,n=L["Old Man Barlo"]}}, },
					-- 3.x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ["Deviate Hatchling"] =                             { cat = WOTLK, type = PET, method = NPC, name = L["Deviate Hatchling"], spellId = 67414, itemId = 48114, npcs = { 3636, 3637 }, chance = 500,  creatureId = 35395, coords = {{m=749}}, },
     ...
     ["Gundrak Hatchling"] =                             { cat = WOTLK, type = PET, method = NPC, name = L["Gundrak Hatchling"], spellId = 67415, itemId = 48116, npcs = { 29334 }, chance = 1000,  creatureId = 35400, coords = {{m=496}}, },
     ["Razzashi Hatchling"] =                            { cat = WOTLK, type = PET, method = ZONE, name = L["Razzashi Hatchling"], spellId = 67420, itemId = 48126, zones = { "689", "37", "673" }, chance = 5000,  creatureId = 35394, coords = {{m=689},{m=37},{m=673}}, },
					-- 4.x                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
     ...
     --["Sting Ray Pup"] =                                 { cat = LEGION, type = PET, method = COLLECTION, name = L["Sting Ray Pup"], spellId = 217218, itemId = 138810, creatureId = 109216, collectedItemId = { 138777 }, chance = 50, },
					...
					["Ironbound Collar"] =																							       { cat = LEGION, type = PET, method = NPC, name = L["Ironbound Collar"], itemId = 142087, spellId = 229094, creatureId = 115139, npcs = { 33186 }, chance = 10,  coords = {{m=529,x=54.3,y=26.5,i=true}},},
					["Magnataur Hunting Horn"] =													           { cat = LEGION, type = PET, method = NPC, name = L["Magnataur Hunting Horn"], itemId = 142084, spellId = 229091, creatureId = 115136, npcs = { 34797 }, chance = 10,  coords = {{m=543,x=51.3,y=52.5,i=true}},},
					["Nerubian Relic"] =																											     { cat = LEGION, type = PET, method = NPC, name = L["Nerubian Relic"], itemId = 142085, spellId = 229092, creatureId = 115137, npcs = { 34564 }, chance = 10,  coords = {{m=543,x=53,y=35.5,i=true}},},
					["Ominous Pile of Snow"] =																		        { cat = LEGION, type = PET, method = NPC, name = L["Ominous Pile of Snow"], itemId = 142090, spellId = 229097, creatureId = 115142, npcs = { 32845 }, chance = 10,  statisticId = {2862, 3256}, doNotUpdateToHighestStat = true,  coords = {{m=529,x=67.1,y=63.4,i=true}},},
					["Overcomplicated Controller"] =									           { cat = LEGION, type = PET, method = NPC, name = L["Overcomplicated Controller"], itemId = 142092, spellId = 229099, creatureId = 115144, npcs = { 33350 }, chance = 10,  statisticId = {2865, 2879}, doNotUpdateToHighestStat = true,  coords = {{m=529,x=43.8,y=40.8,i=true}},},
					["Putricide's Alchemy Supplies"] =									         { cat = LEGION, type = PET, method = NPC, name = L["Putricide's Alchemy Supplies"], itemId = 142096, spellId = 229103, creatureId = 115148, npcs = { 36678 }, chance = 10,  coords = {{m=604,x=12.8,y=53.1,i=true}},},
					["Red-Hot Coal"] =																															   { cat = LEGION, type = PET, method = NPC, name = L["Red-Hot Coal"], itemId = 142086, spellId = 229093,  creatureId = 115138, npcs = { 33118 }, chance = 10,  coords = {{m=529,x=38,y=26.5,i=true}},},
					["Remains of a Blood Beast"] =													         { cat = LEGION, type = PET, method = NPC, name = L["Remains of a Blood Beast"], itemId = 142095, spellId = 229102, creatureId = 115147, npcs = { 37813 }, chance = 10,  statisticId = {4645, 4662, 4663, 4664}, doNotUpdateToHighestStat = true,  coords = {{m=604,x=51.5,y=21.4,i=true}},},
					["Skull of a Frozen Whelp"] =																	      { cat = LEGION, type = PET, method = NPC, name = L["Skull of a Frozen Whelp"], itemId = 142097, spellId = 229104, creatureId = 115149, npcs = { 36853 }, chance = 10,  coords = {{m=604,x=36.5,y=22.6,i=true}},},
					["Stormforged Rune"] =																									     { cat = LEGION, type = PET, method = NPC, name = L["Stormforged Rune"], itemId = 142088, spellId = 229095, creatureId = 115140, npcs = { 32857,32927,32867 }, chance = 10,  coords = {{m=529,x=15.5,y=55.9,i=true}},},
					["Wriggling Darkness"] =																								    { cat = LEGION, type = PET, method = NPC, name = L["Wriggling Darkness"], itemId = 142093, spellId = 229100, creatureId = 115145, npcs = { 33288 }, chance = 10,  statisticId = {2869, 2883}, doNotUpdateToHighestStat = true,  coords = {{m=529,x=68.3,y=39.8,i=true}},},
					-- 7.2
	...
	-- 7.3
     ...
     ["Displacer Meditation Stone"] =                    { cat = LEGION, type = ITEM, isToy = true, method = SPECIAL, name = L["Displacer Meditation Stone"], itemId = 141298, chance = 33, questId = 43943, coords = {{m=1033}} },
					...
					["Fal'dorei Egg"] =                                 { cat = LEGION, type = ITEM, isToy = true, method = SPECIAL, name = L["Fal'dorei Egg"], itemId = 140780, chance = 33, questId = 43943, coords = {{m=1033}} },
					...
					["Shard of Archstone"] =                         { cat = MOP, type = ITEM, isToy = true, method = NPC, name = L["Shard of Archstone"], itemId = 86573, npcs = { 50354, }, chance = 6, coords = { {m=809,x=57.6,y=75.0,n=L["Havak"]} }},
