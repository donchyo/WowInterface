...
Путем выбора '|cFFFFFF00Показать ранг гильдии|r' будут показаны высшие баллы для выбранного босса.
...
L["STRING_HEALING_HPS_FROM"] = "HPS, полученный от"
...
L["STRING_MODE_OPENFORGE"] = "Создание аур"
L["STRING_MODE_OPENGUILDDAMAGERANK"] = "Статистика"
...
L["STRING_OPTIONS_ALWAYS_USE_DESC"] = "Один и тот же профиль используется для всех персонажей. Вы можете переопределить это на любом персонаже, просто выбрав другой существующий профиль."
...
L["STRING_OPTIONS_BG_REMOTE_PARSER_DESC"] = "Когда включено, то наносимый урон и исцеление синхронизируются с таблицей баллов."
...
|cFFFFFF00Авто|r: очистить данные после входа в новое подземелье.]=]
...
L["STRING_OPTIONS_MAXINSTANCES_DESC"] = [=[Ограничьте количество создаваемых окон.

Управление окнами осуществляется через меню управления окнами.]=]
...
L["STRING_OPTIONS_OVERALL_ALL_DESC"] = "Все сегменты добавляются в общие данные."
...
L["STRING_OPTIONS_OVERALL_DUNGEONCLEAN"] = "Мусор подземелий"
L["STRING_OPTIONS_OVERALL_DUNGEONCLEAN_DESC"] = "Сегменты с подземельным мусором, добавляются к общим данным."
L["STRING_OPTIONS_OVERALL_LOGOFF"] = "Очищать при выходе из мира"
L["STRING_OPTIONS_OVERALL_LOGOFF_DESC"] = "Когда включено, общие данные автоматически удаляются при выходе из игрового мира."
L["STRING_OPTIONS_OVERALL_MYTHICPLUS"] = "Очистить при старте Эпохального+"
L["STRING_OPTIONS_OVERALL_MYTHICPLUS_DESC"] = "При включении, общие данные автоматически удаляются при запуске нового эпохального+ захода."
L["STRING_OPTIONS_OVERALL_NEWBOSS"] = "Очищать при новым рейдовым боссе"
L["STRING_OPTIONS_OVERALL_NEWBOSS_DESC"] = "Когда включено, общие данные автоматически удаляются при столкновении с другим рейдовым боссом."
...
L["STRING_OPTIONS_PANIMODE_DESC"] = "Если это включено, и вас выбросило из игры (например, потеря соединения в подземелье) и вы дрались против босса, все сегменты стираются, это делает ваш процесс выхода быстрее."
L["STRING_OPTIONS_PDW_ANCHOR"] = "Панели:"
L["STRING_OPTIONS_PDW_SKIN_DESC"] = [=[Скин, который будет использоваться в окне детальной информации, окне отчета и панели параметров.
...
|cFFFFFF00Relative Top Player|r: процент относительно предела баллов лучшего игрока.]=]
...
L["STRING_OPTIONS_PERFORMANCE1_DESC"] = "Эти параметры могут помочь сэкономить, некоторое ресурсы процессора."
...
L["STRING_OPTIONS_PROFILE_GLOBAL"] = "Выберите профиль, который будет использоваться для всех персонажей."
L["STRING_OPTIONS_PROFILE_LOADED"] = "Профиль загружен:"
L["STRING_OPTIONS_PROFILE_NOTCREATED"] = "Профиль не создан."
L["STRING_OPTIONS_PROFILE_OVERWRITTEN"] = "вы выбрали определенный профиль для этого персонажа"
...
L["STRING_OPTIONS_PROFILE_SELECT"] = "выберите профиль."
L["STRING_OPTIONS_PROFILE_SELECTEXISTING"] = "Выберите существующий профиль или продолжите использовать новый для этого персонажа:"
...
L["STRING_OPTIONS_PROFILES_COPY_DESC"] = "Скопировать все настройки из выбранного профиля в текущий профиль, перезаписав все значения."
...
L["STRING_OPTIONS_PROFILES_CURRENT_DESC"] = "Это имя текущего активированного профиля."
...
L["STRING_OPTIONS_PROFILES_RESET_DESC"] = "Сброс всех настроек выбранного профиля на значения по умолчанию."
L["STRING_OPTIONS_PROFILES_SELECT"] = "Выбрать профиль"
L["STRING_OPTIONS_PROFILES_SELECT_DESC"] = "Загрузить существующий профиль. Если используется один и тот же профиль, тогда все персонажи (Параметр использовать на всех персонажей»), для этого персонажа создается исключение."
...
L["STRING_OPTIONS_PVPFRAGS_DESC"] = [=[Когда включено, только убийства против вражеских игроков рассчитываются на
|cFFFFFF00урон > убийства|r дисплея.]=]
...
L["STRING_OPTIONS_REPORT_HEALLINKS_DESC"] = [=[При отправке отчета и включении этого параметра, |cFF55FF55полезные|r заклинания сообщаются с помощью заклинания, а не его имени.

|cFFFF5555Вредные|r заклинания, сообщаются по ссылкам, по умолчанию.]=]
L["STRING_OPTIONS_REPORT_SCHEMA"] = "Формат"
L["STRING_OPTIONS_REPORT_SCHEMA_DESC"] = "Выберите текстовый формат для текста, на отправляемый канал чата."
...
L["STRING_OPTIONS_ROWADV_TITLE_DESC"] = "Эти параметры позволяют изменять строки более глубоко."
...
L["STRING_OPTIONS_RT_FIRST_HIT_DESC"] = "Пишет в панель чата (|cFFFFFF00только для вас|r), кто нанёс первый удар, как правило, это тот, кто начал бой."
...
L["STRING_OPTIONS_TEXTEDITOR_CANCEL_TOOLTIP"] = "Завершите редактирование и игнорировать любые изменения в коде."
...
L["STRING_OPTIONSMENU_DISPLAY_DESC"] = "Общие основные настройки и быстрое управление окнами."
...
L["STRING_OPTIONSMENU_SPELLS_CONSOLIDATE"] = "Объединять общие заклинания с тем же именем"
...
L["STRING_SCORE_BEST"] = "ваши баллы |cFFFFFF00%s|r, это твой лучший балл, поздравляю!"
L["STRING_SCORE_NOTBEST"] = "ваши баллы |cFFFFFF00%s|r, ваш лучший результат был |cFFFFFF00%s|r на %s с %d уровнем предметов."
...
Каждый скин реагирует по-разному на импортированные настройки.]=]
L["STRING_WELCOME_58"] = [=[Предопределенные наборы конфигураций внешнего вида.

|cFFFFFF00Важно|r: все настройки могут быть изменены, позже на панели параметров.]=]
...
L["STRING_WELCOME_63"] = "Обновление УВС/ИВС в режиме реaльного времени"
...
L["STRING_WELCOME_66"] = [=[Перетащите окно рядом с другим, чтобы создать группу.

Группированные окна растягиваются и изменяют размер вместе.

Они также живут счастливее, как пара.]=]
L["STRING_WELCOME_67"] = [=[Держите Shift, чтобы развернуть подсказку игрока для показа всех используемых заклинаний.
...
Оно везде, и
поможет Вам со многими задачами.

Например: измеритель угроз, анализ увс, сводка схваток, создание диаграмм и многое другое.]=]
L["STRING_WELCOME_69"] = "Пропустить"
L["STRING_WELCOME_7"] = "используется для рейтинга, этот метод использует прошедшее боевое время для измерения, УВС и ИВС на всех участников рейда."
