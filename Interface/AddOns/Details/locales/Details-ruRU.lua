...
L["STRING_OPTIONS_PROFILES_SELECT_DESC"] = "Загрузить существующий профиль. Если используется один и тот же профиль на всех персонажах (Параметр - Использовать на всех персонажах), то для этого персонажа создается исключение."
