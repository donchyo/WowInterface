...
L["STRING_CUSTOM_CC_DONE"] = "CC Efetuado"
L["STRING_CUSTOM_CC_RECEIVED"] = "CC Recebido"
...
L["STRING_CUSTOM_SKIN_TEXTURE"] = "Skin Customizado"
...
|cFFFFFF00Importante:|r antes de criar o arquivo, feche o jogo. Após fazer isto, um simples /reload aplica as alterações feitas no arquivo de textura.]=]
...
L["STRING_FEEDBACK_CURSE_DESC"] = "Abra um ticket ou deixe uma mensagem na página do Details!."
L["STRING_FEEDBACK_MMOC_DESC"] = "Poste em nosso tópico no fórum do mmo-champion."
L["STRING_FEEDBACK_PREFERED_SITE"] = "Escolha sua página preferida:"
...
L["STRING_OPTIONS_BAR_ICONFILE3"] = "Padrão (em preto e branco)"
L["STRING_OPTIONS_BAR_ICONFILE4"] = "Padrão (transparentes)"
...
L["STRING_OPTIONS_BARLEFTTEXTCUSTOM2"] = "não usou"
