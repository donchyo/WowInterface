...
function AAP_MakeBanners()
	...
	AAP.Banners.BannersFrame.Frame:SetWidth(40)
	...
	AAP.Banners.BannersFrame.B1:SetText("21s")
	...
	AAP.Banners.BannersFrame.B2:SetText("22s")
	...
	AAP.Banners.BannersFrame.B3:SetText("23s")
	...
	for CLi = 1, 4 do
		...
		AAP.Banners.BannersFrame["Frame"..CLi]:SetWidth(40)
		AAP.Banners.BannersFrame["Frame"..CLi]:SetHeight(20)
		AAP.Banners.BannersFrame["Frame"..CLi]:SetPoint("TOPLEFT", AAP.Banners.BannersFrame, "TOPLEFT",-(39*CLi),0)
