...
L["If checked, additional functionality will be added to the world map frame.|n|nCharacter and cursor coordinates will be shown at the top, map fading will be disabled and the map reading emote will be disabled."] = "勾选后，会给世界地图添加部分新功能。|n|n玩家和鼠标的左边会显示在地图上方，地图渐隐功能会被禁用，同时禁用的还有查看地图时的表情动作。"
...
L["If checked, dungeon and raid locations will be shown for all game expansions up to and including Warlords of Draenor.|n|nLegion dungeon and raid locations are managed by the default user interface."] = "勾选后，地下城和团队副本入口将会显示至德拉诺之王资料片。|n|n军团再临的相关入口已由系统插件自带。"
...
L["If checked, portals for Suramar (Broken Isles) and Ashran (Draenor) will be shown."] = "勾选后，苏拉玛的传送门（破碎群岛）和阿什兰（德拉诺）将会显示在地图上。"
...
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced.|n|nEnabling this option will also enable auto loot in the game options panel."] = "勾选后，会显著的降低自动拾取所花的时间。|n|n勾选这个选项，也会同时启用界面-控制中的自动拾取选项。"
...
L["Show older dungeon and raid locations"] = "显示经典旧世地下城和团队副本的入口"
L["Show pet save button"] = "保存宠物按钮"
L["Show player chain"] = "显示玩家边框"
L["Show portals for Suramar and Ashran"] = "显示苏拉玛和阿什兰的传送门"
...
L["If checked, additional functionality will be added to the world map frame.|n|nCharacter and cursor coordinates will be shown at the top, map fading will be disabled and the map reading emote will be disabled."] = "勾選後，世界地圖框架將增加額外功能。|n|n角色與滑鼠座標將顯示在頂部，地圖淡出與讀取地圖表情都將會停用。"
...
L["If checked, dungeon and raid locations will be shown for all game expansions up to and including Warlords of Draenor.|n|nLegion dungeon and raid locations are managed by the default user interface."] = "勾選後，所有遊戲資料片的地城和團隊副本位置將會顯示，甚至包括德拉諾之霸在內。|n|n軍臨天下地城與團隊副本位置由預設使用者介面管理。"
...
L["If checked, portals for Suramar (Broken Isles) and Ashran (Draenor) will be shown."] = "勾選後，蘇拉瑪爾（破碎群島）與阿斯蘭（德拉諾）的傳送門將會顯示。"
...
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced.|n|nEnabling this option will also enable auto loot in the game options panel."] = "勾選後，自動拾取所需的時間將大幅減少。|n|n啟用此選項也會在遊戲選項中啟用自動拾取。"
...
L["If checked, the minimap title bar and the calendar button will be hidden.  Right-clicking the tracking button will open the calendar.|n|nIn addition, you will be able to rescale the minimap and use the mousewheel to zoom."] = "勾選後，小地圖標題條以及行事曆按鈕將隱藏。右鍵點擊追蹤按鈕將開啟行事曆。|n|n此外您還可以重設小地圖大小並使用滑鼠滾輪來縮放區域。"
...
L["Show older dungeon and raid locations"] = "顯示懷舊地城與團隊副本位置"
L["Show pet save button"] = "顯示寵物儲存按鈕"
L["Show player chain"] = "顯示玩家邊框"
L["Show portals for Suramar and Ashran"] = "顯示蘇拉瑪爾與阿斯蘭的傳送門"
...
L["If checked, dungeon and raid locations will be shown for all game expansions up to and including Warlords of Draenor.|n|nLegion dungeon and raid locations are managed by the default user interface."] = "모든 던전의 위치가 표시됩니다.|n|n군단 던전 위치는 기본사용자 인터페이스(블리자드)로 관리됩니다."
...
L["If checked, portals for Suramar (Broken Isles) and Ashran (Draenor) will be shown."] = "수라마르(부서진 섬) 및 아쉬란(드레노어)의 포털이 표시 됩니다."
...
L["Show older dungeon and raid locations"] = "(옛)던전과 공격대 위치 표시"
L["Show pet save button"] = "애완동물 저장 버튼"
L["Show player chain"] = "플레이어 테두리 표시"
L["Show portals for Suramar and Ashran"] = "수라마르,아쉬란의 차원문 표시"
