...
L["Broken Isles"] = "破碎群島"
L["Broken Shore"] = "破碎海岸"
L["Broken Shore (Alliance)"] = "破碎群島（聯盟）"
L["Broken Shore (Horde)"] = "破碎群島（部落）"
L["Buff Frame"] = "增益框架"
L["Buffs"] = "增益"
...
L["Game Options"] = "游戲設置"
L["Garrison Shipyard (Alliance)"] = "要塞船塢（聯盟）"
L["Garrison Shipyard (Horde)"] = "要塞船塢（部落）"
L["Ghost"] = "靈魂狀態框架"
L["Ghostlands"] = "鬼魂之地"
L["Gold Only"] = "僅輸入金幣"
L["Gorgrond"] = "格古隆德"
...
L["Hellfire Citadel (1)"] = "地獄火堡壘 (1)"
L["Hellfire Citadel (2)"] = "地獄火堡壘 (2)"
...
L["Krasarang Wilds (Alliance)"] = "喀撒朗蠻荒（聯盟）"
L["Krasarang Wilds (Horde)"] = "喀撒朗蠻荒（部落）"
...
L["Siege of Orgrimmar (Alliance)"] = "圍攻奧格瑪（聯盟）"
L["Siege of Orgrimmar (Horde)"] = "圍攻奧格瑪（部落）"
...
L["Broken Shore (Alliance)"] = "부서진 해변 (얼라이언스)"
L["Broken Shore (Horde)"] = "부서진 해변 (호드)"
L["Buff Frame"] = "버프 프레임"
L["Buffs"] = "버프"
...
L["Garrison Shipyard (Alliance)"] = "주둔지 조선소(얼라이언스)"
L["Garrison Shipyard (Horde)"] = "주둔지 조선소(호드)"
L["Ghost"] = "유령"
L["Ghostlands"] = "유령의 땅"
L["Gold Only"] = "골드 만!"
L["Gorgrond"] = "고르그론드"
...
L["Hellfire Citadel (1)"] = "지옥불 성채(1)"
L["Hellfire Citadel (2)"] = "지옥불 성채(2)"
...
L["If checked, battle pets which are automatically summoned will be dismissed within a few seconds.|n|nThis includes dragging a pet onto the first team slot in the pet journal and entering a battle pet team save command.|n|nNote that pets which are automatically summoned during combat will be dismissed when combat ends."] = "자동으로 소환되는 전투팻이 몇초 이내 해제됩니다.|n|n애완동물도감의 그룹저장 포함?|n|n팻전투가 끝나면 자동으로 소환됩니다."
...
L["If checked, in-game cinematics will be skipped if at all possible.|n|nYou can hold the shift key down when a cinematic is about to start to override this setting.|n|nNote that some cinematics cannot be skipped."] = "가능하다면 게임 속 동영상을 건너 뜁니다. |n|n무시하려면 시작할 때 시프트 키를 누르고 있습니다. | n | n 일부 시네마틱을 건너 뛸 수 없다는 것을 유의하십시오."
...
L["Krasarang Wilds (Alliance)"] = "크라사랑 밀림(얼라이언스)"
L["Krasarang Wilds (Horde)"] = "크라사랑 밀림(호드)"
...
L["Siege of Orgrimmar (Alliance)"] = "오그리마 공성전 (얼라이언스)"
L["Siege of Orgrimmar (Horde)"] = "오그리마 공성전 (호드)"
...
L["Yrel and the Dark Star"] = "이렐과 검은 별"
L["Ysera's Corruption"] = "이세라의 타락"
