...
ns.L = {
	...
	CONFIG_COUNTER_TRAIT = "Show the abilities of a mission and if it can be countered", -- Requires localization
	...
	SALVAGE_YARD = "Depósito de Ferro-velho", -- Needs review
